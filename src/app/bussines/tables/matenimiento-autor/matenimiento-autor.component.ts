...
@Component({
  selector: 'app-matenimiento-autor',
  templateUrl: './matenimiento-autor.component.html',
  styleUrl: './matenimiento-autor.component.scss'
})
export class MatenimientoAutorComponent {
